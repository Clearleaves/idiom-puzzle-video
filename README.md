...
一个 Codex Skill：把四字成语制作成包含原创谜面、倒计时、提示和答案揭晓的竖屏短视频。

## 效果与能力

- 默认 1080×1920、24 fps、16 秒，导出 H.264 MP4（无音轨） 和 JPG 封面。
- 前 11 秒猜题，后 5 秒揭晓；猜题与答案时长可配置。
- 无 BGM、音效和口播，发布时可直接选择平台配乐。
- 暖米色背景、立体静物谜面，统一栏目风格。
...
脚本会完整解码视频、检查视频流（成片无音轨），并输出检查报告。仍应人工检查谜面顺序、文字、答案和代表帧。谐音谜题可能存在声调差异或歧义，不应当作严格的语文教学标准。画面中的 AI 提示不代替发布平台要求的内容声明。
